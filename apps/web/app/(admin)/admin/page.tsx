...
import { Card, Row, Col, Statistic, Space, Button, Badge, Typography, Table, Tag } from 'antd';
...
const Q_DASH = gql`
  query {
    ...
    latestPosts(limit:5){ id title status created_at }
    latestUsers(limit:5){ id name email role created_at }
  }
`;
